...
- two environment variables are added for backend docker: POSTGRES_PASSWORD is used to store database password. DATABASE_RUNNING_IN_DOCKER is used to let backend code logic check if application is running in Docker.
